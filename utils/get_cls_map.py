...
def list_to_colormap(x_list):
    ...
    for index, item in enumerate(x_list):
        ...
        if item == 17:
            y[index] = np.array([(255, 165, 1)]) / 255.
        if item == 18:
            y[index] = np.array([(127, 255, 1)]) / 255.
        if item == 19:
            y[index] = np.array([(139, 139, 1)]) / 255.
        if item == 20:
            y[index] = np.array([(1, 139, 139)]) / 255.
        if item == 21:
            y[index] = np.array([(205, 181, 205)]) / 255.
        if item == 22:
            y[index] = np.array([(238, 154, 1)]) / 255.
...
###生成效果图代码
def get_cls_map(net, device, all_data_loader, y, cls_num, ratio):
    if cls_num == 1:
        ...
        classification_map(y_re, y, 300,
                           'classification_maps/' + str(ratio) + '_IP_predictions.eps')
        classification_map(y_re, y, 300,
                           'classification_maps/' + str(ratio) + '_IP_predictions.png')
        classification_map(gt_re, y, 300,
                           'classification_maps/' + str(ratio) + '_IP_gt.png')
        ...
        gt_re = np.reshape(y_gt, (y.shape[0], y.shape[1], 3))
        classification_map(y_re, y, 300,
                           'classification_maps/' + str(ratio) + '_UP_predictions.eps')
        classification_map(y_re, y, 300,
                           'classification_maps/' + str(ratio) + '_UP_predictions.png')
        classification_map(gt_re, y, 300,
                           'classification_maps/' + str(ratio) + '_UP_gt.png')
        print('------Get classification maps successful-------')
    elif cls_num == 3:
        y_pred, y_new = test(device, net, all_data_loader)
        cls_labels = get_classification_map(y_pred, y)
        ...
        gt_re = np.reshape(y_gt, (y.shape[0], y.shape[1], 3))
        classification_map(y_re, y, 300,
                           'classification_maps/' + str(ratio) + '_HU_predictions.eps')
        classification_map(y_re, y, 300,
                           'classification_maps/' + str(ratio) + '_HU_predictions.png')
        classification_map(gt_re, y, 300,
                           'classification_maps/' + str(ratio) + '_HU_gt.png')
        print('------Get classification maps successful-------')
    elif cls_num == 4:
        y_pred, y_new = test(device, net, all_data_loader)
        cls_labels = get_classification_map(y_pred, y)
        ...
        gt_re = np.reshape(y_gt, (y.shape[0], y.shape[1], 3))
        classification_map(y_re, y, 300,
                           'classification_maps/' + 'BA_predictions.eps')
        classification_map(y_re, y, 300,
                           'classification_maps/' + 'BA_predictions.png')
        classification_map(gt_re, y, 300,
                           'classification_maps/' + 'BA_gt.png')
        print('------Get classification maps successful-------')
